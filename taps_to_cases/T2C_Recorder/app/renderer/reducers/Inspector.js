...
import {
  ...
  SET_FIELD_VALUE,
  SET_EXPANDED_PATHS,
  SHOW_SEND_KEYS_MODAL,
  HIDE_SEND_KEYS_MODAL,
  START_RECORDING,
  PAUSE_RECORDING,
  CLEAR_RECORDING,
  ...
  SELECT_ACTION_GROUP,
  SELECT_SUB_ACTION_GROUP,
  SET_APP_MODE,
  SELECT_INTERACTION_MODE,
  ENTERING_ACTION_ARGS,
  SET_ACTION_ARG,
  REMOVE_ACTION,
  SET_CONTEXT,
  ...
  SET_SERVER_STATUS,
  SET_SESSION_TIME,
  UPDATE_RECORDEDTESTCASES,
  ADD_TESTCASE,
  UPDATE_DRIVERLIST,
  SET_UI_CHANGE_MONITOR,
  SET_LAST_UI_CHANGE_TIME,
  SET_PAGE_SOURCE_HASH,
  SET_IS_UI_REFRESHING,
  SET_IS_SWITCHING,
  SHOW_GET_INFO_MODAL,
  HIDE_GET_INFO_MODAL,
  SHOW_DO_APP_ACTION,
...
const INITIAL_STATE = {
  ...
  driverList: [],
  getInfoList: new Map(),
  uiChangeMonitor: null,
  lastUiChangeTime: null,
  pageSourceHash: '',
...
export default function inspector(state = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case SHOW_GET_INFO_MODAL:
      return {
        ...state,
        getInfoModalVisible: true,
      };

    case HIDE_GET_INFO_MODAL:
      return {
        ...state,
    ...
    case SHOW_DO_APP_ACTION:
      return {
        ...state,
        doAppActionVisible: true,
      };
    case HIDE_DO_APP_ACTION:
      return {
        ...state,
        doAppActionVisible: false,
      }
    ...
    case UPDATE_RECORDEDTESTCASES:
      return {
        ...state,
        testCases: action.testCases,
      };
    case SET_GET_INFO_LIST:
      return {
        ...state,
        getInfoList: action.getInfoList,
      }
    case UPDATE_DRIVERLIST:
      return {
        ...state,
        driverList: action.driverList,
      }
    case CLEAR_DRIVERLIST:
      return {
        ...state,
        driverList: [],
      }
    ...
    case HIDE_ASSERT_MODAL:
      return {
        ...state,
        assertModalVisible: false,
      }
    case SHOW_SLEEP_MODAL:
      return {
        ...state,
        sleepModalVisible: true,
      }
    case HIDE_SLEEP_MODAL:
      return {
        ...state,
    ...
    case SET_UI_CHANGE_MONITOR:
      return {
        ...state,
        uiChangeMonitor: action.uiChangeMonitor
      };

    case SET_LAST_UI_CHANGE_TIME:
      return {
        ...state,
        lastUiChangeTime: action.lastUiChangeTime,
      };

    case SET_PAGE_SOURCE_HASH:
      return {
        ...state,
        pageSourceHash: action.pageSourceHash,
      };

    case SET_IS_UI_REFRESHING:
      return {
        ...state,
        isUIRefreshing: action.isUIRefreshing,
      }
