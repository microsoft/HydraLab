...
export function isElementContainer(element1, elements) {
...
export function isElementOverElement(element1, element2) {
...
export function isAncestor(curElement, maybeAncestor, elements) {
