...
VALUES('app_file_id', 'http://127.0.0.1:9886/api/storage/local/download/pkgstore/2023/04/23/hydra_lab_android_client_release.apk', 'pkgstore', '2023/04/23/hydra_lab_android_client_release.apk', 'http://127.0.0.1:9886/api/storage/local/download/pkgstore/2023/04/23/hydra_lab_android_client_release.apk', '1682229902467', 261732, 'hydra_lab_android_client_release.apk', '{"minSdkVersion":"21","appName":"HydraLab Client","pkgName":"com.microsoft.hydralab.android.client","targetSdkVersion":"28","version":"2.6.0"}', 'APP', NULL, NULL, '618aa2ac2817f2c9404d17b1e4d14c1b', '1682229902467');
INSERT INTO blob_file_info
(file_id, cdnurl, blob_container, blob_path, blob_url, create_time, file_len, file_name, file_parser, file_type, load_dir, load_type, md5, update_time)
VALUES('test_app_file_id', 'http://127.0.0.1:9886/api/storage/local/download/pkgstore/2023/04/23/hydra_lab_android_client_androidTest.apk', 'pkgstore', '2023/04/23/hydra_lab_android_client_androidTest.apk', 'http://127.0.0.1:9886/api/storage/local/download/pkgstore/2023/04/23/hydra_lab_android_client_androidTest.apk', '1682229903023', 527485, 'hydra_lab_android_client_androidTest.apk', '{"minSdkVersion":"21","pkgName":"com.microsoft.hydralab.android.client.test","targetSdkVersion":"33"}', 'TEST_APP', NULL, NULL, '9efdd140688be18e580941cba768bb6f', '1682229903023');
