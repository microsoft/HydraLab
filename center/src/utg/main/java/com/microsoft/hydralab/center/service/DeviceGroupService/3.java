...
public void testDeleteGroup() {
 String groupName = "TestGroup"; deviceGroupService.deleteGroup(groupName); Mockito.verify(deviceGroupRepository).deleteById(groupName); Mockito.verify(deviceGroupRelationRepository).deleteAllByGroupName(groupName); 
}
