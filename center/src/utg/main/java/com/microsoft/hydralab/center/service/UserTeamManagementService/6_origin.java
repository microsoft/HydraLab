...
public class UserTeamManagementServiceTest {
    ...
    public void setUp() {
        ...
        userTeamManagementService.userTeamRelationRepository = userTeamRelationRepository;
        userTeamManagementService.sysTeamService = sysTeamService;
        userTeamManagementService.sysUserService = sysUserService;
        userTeamManagementService.sysRoleService = sysRoleService;
    }
    ...
    public void testCheckUserTeamRelation() {
        ...
        // Mock the behavior of the userTeamRelationRepository
