...
public void testDeleteTeam() {
 SysTeam team = new SysTeam(); team.setTeamId("1"); team.setTeamName("Team 1"); team.setCreateTime(new Date()); team.setUpdateTime(new Date()); teamListMap.put(team.getTeamId(), team); sysTeamService.deleteTeam(team); Mockito.verify(sysTeamRepository).deleteById(team.getTeamId()); Mockito.verify(sysTeamService.teamListMap).remove(team.getTeamId()); 
}
