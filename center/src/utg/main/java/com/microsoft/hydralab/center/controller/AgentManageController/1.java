...
public void testGetCenterInfo() {
 JSONObject expectedData = new JSONObject(); expectedData.put("versionName", "versionName"); expectedData.put("versionCode", "versionCode"); expectedData.put("agentPkg", "agentPackage"); Result result = agentManageController.getCenterInfo(); assert result != null; assert result.getStatus() == HttpStatus.OK.value(); assert result.getData().equals(expectedData); 
}
