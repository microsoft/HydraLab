...
public class DOMElementWriter
{
	 ...
	 */
	private final HashMap<String, String> nsPrefixMap = new HashMap<>();
	 ...
	 */
	private HashMap<Element, ArrayList<String>> nsURIByElement = new HashMap<>();
	...
	{
		ArrayList<String> al = nsURIByElement.get(element);
		if (al == null) {
			al = new ArrayList<>();
