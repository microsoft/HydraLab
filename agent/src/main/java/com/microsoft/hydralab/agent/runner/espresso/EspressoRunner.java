...
public class EspressoRunner extends TestRunner {
    ...
    public EspressoRunner(DeviceManager deviceManager, TestTaskRunCallback testTaskRunCallback, ADBOperateUtil adbOperateUtil, PerformanceTestManagementService performanceTestManagementService) {
