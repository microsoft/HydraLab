...
public class ContentWriter {
    ...
    private boolean mClearIcon = false;
    ...
    public ContentWriter putIcon(Bitmap bitmap, UserHandle user) {
    ...
    public ContentWriter clearIcon() {
        mClearIcon = true;
        return this;
    }
    ...
    public ContentValues getValues(Context context) {
        ...
        if (mClearIcon) {
            mValues.put(LauncherSettings.Favorites.ICON, (byte[]) null);
            mClearIcon = false;
            mIcon = null;
        } else if (mIcon != null && mIcon.icon != null && !LauncherAppState.getInstance(context).getIconCache()
