...
logo: {{site.baseurl}}/HydraLab/assets/images/logo.png
show_sidebar: true
---
...
-   Or: Onboard your test device to an existing network with low-cost and small effort.
    ![technical_architecture]({{site.baseurl}}/HydraLab/assets/images/technical_architecture.png){:height="60%" width="60%"}
